...
/*
-[x]When encoding, your output should still be a string.
-[x]When decoding, the number of characters in the string excluding spaces should be even. Otherwise, return false.
-[x]Spaces should be maintained throughout.
-[x]Capital letters can be ignored.
-[x]The letters "I" and "J" share a space. When encoding, both letters can be converted to 42, but when decoding, both letters should somehow be shown.
*/
